...
public class MobHp : MonoBehaviour
{
    ...
    void PHFollowEnemy()
    {
        ...
        hpbarWorldPosition = new Vector3(this.transform.position.x, this.transform.position.y + 1.5f, this.transform.position.z);//血條3D位置=怪物+偏量 
        hpbar.transform.localScale = new Vector3(1, 1, 1); //縮放是1
